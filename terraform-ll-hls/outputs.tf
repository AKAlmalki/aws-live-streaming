...
output "mediapackage_hls_origin_url" {
  description = "Direct MediaPackage v2 standard HLS manifest URL."
  value       = aws_cloudformation_stack.mediapackage_v2.outputs["HlsManifestUrl"]
}

output "mediapackage_ll_hls_origin_url" {
  description = "Direct MediaPackage v2 LL-HLS manifest URL."
  value       = aws_cloudformation_stack.mediapackage_v2.outputs["LlHlsManifestUrl"]
}
...
output "cloudfront_playback_url" {
  description = "CloudFront URL to the standard HLS master manifest."
  value       = "https://${aws_cloudfront_distribution.hls.domain_name}/index.m3u8"
}

output "cloudfront_playback_url_hls" {
  description = "CloudFront URL to the standard HLS master manifest."
  value       = "https://${aws_cloudfront_distribution.hls.domain_name}/index.m3u8"
}

output "cloudfront_playback_url_ll_hls" {
  description = "CloudFront URL to the LL-HLS master manifest."
  value       = "https://${aws_cloudfront_distribution.hls.domain_name}/indexll.m3u8"
}
